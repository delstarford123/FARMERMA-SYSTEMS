...
def load_csv_to_db(filepath):
    with app.app_context():
        ...
        # Loop through the CSV and create database records using standard library csv module
        records_count = 0
        ...
        db.session.commit()
        print(f"Successfully loaded {records_count} records from {filepath} into the database!")
